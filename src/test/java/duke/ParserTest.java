...
public class ParserTest {
    @Test
    public void parserTestForStop() throws IOException, DeleteException, DukeException {
    ...
    @Test
    public void parserTestForRun() throws DeleteException, DukeException, IOException {
