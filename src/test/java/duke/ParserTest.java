...
public class ParserTest {
    ...
    public void parse_deadlineCommand_stringArray() {
        ...
        String[] deadlineCommandArray = new String[]{"add", "deadline", "finish all week 3 iP tasks", "2021 08 30 2359"};
    ...
    public void parse_eventCommand_stringArray() {
        ...
        String[] eventCommandArray = new String[]{"add", "event", "morning lecture", "2021 09 01 0900", "2021 09 01 1000"};
