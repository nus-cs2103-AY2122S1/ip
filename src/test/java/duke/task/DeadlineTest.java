...
public class DeadlineTest {
    ...
    void testToStringDate() {
        Deadline dl = new Deadline("hi yay", "26 August 2021");
        assertEquals("[D][] hi yay (by: 26 August 2021)", dl.toString());
    }

    @Test
    void testToStringNormal() {
        Deadline dl = new Deadline("sleep", "12am midnight");
        assertEquals("[D][] sleep (by: 12am midnight)", dl.toString());
    }
    ...
    void testMarkAsDoneToString() {
        Deadline dl = new Deadline("hi yay", "26 August 2021");
        dl.markAsDone();
        assertEquals("[D][X] hi yay (by: 26 August 2021)", dl.toString());
    }
