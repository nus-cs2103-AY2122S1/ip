...
public class ParserTest {
    ...
    public void testParseValidInput() {
        ...
        Assertions.assertEquals(true, Parser.parse(inputList, null, makeTasks(), null) instanceof
                ListCommand, "Wrongly parses list command");

        Assertions.assertEquals(true, Parser.parse(inputDone, null, makeTasks(), null) instanceof
        ...
        Assertions.assertEquals(true, Parser.parse(inputExit, null, makeTasks(), null) instanceof
                ExitCommand, "Wrongly parses exit command");
