...
public class CommandMessage {
    ...
    protected static final String MESSAGE_MATCHING_CONTENTS = "Here are the matching task(s) to the word(s) in '%s':";
    protected static final String MESSAGE_NO_MATCHING_CONTENTS = "There are no matching tasks to the word(s) in '%s':";
