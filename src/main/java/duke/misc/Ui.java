...
public class Ui {
    ...
    /** Message to display when ByeCommand executed. */
    ...
    /** Message to display when deleteCommand executed. */
    public static final String DELETE_MSG = "I have deleted this task:\n";
    /** Message to display when FindCommand executed. */
    public static final String FIND_MSG = "Here are what i found:\n";
}
