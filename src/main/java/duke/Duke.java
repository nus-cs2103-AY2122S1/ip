...
public class Duke extends Application {
    ...
    private Image user = new Image(this.getClass().getResourceAsStream("/images/jotaro.png"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/dio.png"));
