...
public class Duke extends Application {
    ...
    private Scene scene;
    private Image user = new Image(this.getClass().getResourceAsStream("/images/mrbean.jpg"));
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/saitama.jpg"));
