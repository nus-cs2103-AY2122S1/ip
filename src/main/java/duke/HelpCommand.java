...
public class HelpCommand {
    ...
    private static String generalHelp = "You require my assistance! \n Dukebot is a app that helps you create many basic tasks " +
            "and complete them. Here are some basic commands that are supported as of this current version" +
            "\n \n" +
            "1. Todo creation\n" +
            "2. Deadline creation\n" +
            "3. Event creation\n" +
    ...
    private static String deadline = "Deadlines are tasks with a specific date to be completed. They created with the" +
    ...
    private static String find = "Find allows for searching of tasks with the specified keyword. This is essentially a " +
            "filter. " +
