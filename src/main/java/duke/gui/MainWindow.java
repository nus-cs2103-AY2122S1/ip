...
public class MainWindow extends AnchorPane {
    ...
    private Duke duke;
    private Image userAvatar = new Image(this.getClass().getResourceAsStream("/images/sasuke.png"));
    private Image dukeAvatar = new Image(this.getClass().getResourceAsStream("/images/naruto.jpg"));
