...
/**
 * The ErrorCommand class encapsulates an unrecognised command from the user.
 */
public class ErrorCommand extends Command {

    /**
     * Executes the response to an erroneous command from the user.
     *
