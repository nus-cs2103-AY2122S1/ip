...
public class Ui {
    ...
    protected void instruct() {
        System.out.println("Here's the commands you can input for me!\n" +
                            ...
                            "\"done _\" : enter done followed by a whitespace and the number of the task you want to be set as done\n" +
                            "\"delete _\" : enter delete followed by a whitespace and the number of the task you wish to delete from the list!\n" +
                            "\"todo __\" : enter todo followed by the task you wish to add to the list\n" +
                            "\"deadline __ /by yyyy-mm-dd HHmm\" enter deadline followed by the task name and deadline in the format stated.\n" +
                            "\"event __ /at yyyy-mm-dd HHmm\" enter deadline followed by the task name and event time in the format stated.");
