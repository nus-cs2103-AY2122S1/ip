...
public class DialogBox extends HBox {
     ...
     * @return A dialog box containing the text and the profile image of the user.
     */
    ...
    /**
     * Returns a dialog box representing Duke.
     *
     * @param text The text from Duke.
     * @param img The profile image of Duke.
     * @return A dialog box containing the text and the profile image of Duke.
     */
