...
public class DialogBox extends HBox {
    ...
    /**
     * Gets a DialogBox to display user's input
     *
     * @param text String to display user input
     * @param img User's image to be displayed
     * @return A DialogBox that displays user's input
     */
     ...
     * @param img Duke's image to be displayed
