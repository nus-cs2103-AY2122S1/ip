...
public class TempDuke extends Application {
    ...
    private Scene scene;
    private Image userImg = new Image(this.getClass().getResourceAsStream("/images/globe.jpg"));
    private Image dukeImg = new Image(this.getClass().getResourceAsStream("/images/soap-bubble.jpg"));
