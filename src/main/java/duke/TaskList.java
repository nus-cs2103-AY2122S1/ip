...
public class TaskList {
    ...
    public String delete(String num, Storage storage, Ui ui) throws DukeException {
        try {
            ...
            return String.format("%s %s", ui.printDeleteMessage(deletedTask), ui.printTaskListSize(this.taskList.size()));
        } catch (IndexOutOfBoundsException e) {
    ...
    public String createTodo(String description, Storage storage, Ui ui) {
        ...
        return String.format("%s %s", ui.printAddMessage(addedTask), ui.printTaskListSize(this.taskList.size()));
    }
