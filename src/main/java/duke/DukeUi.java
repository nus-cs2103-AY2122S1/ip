...
public class DukeUi extends Application {
    ...
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/DaDuck.jpg"));
    ...
    public void start(Stage primaryStage) {
        ...
        dialogContainer.getChildren().addAll(
                DialogBox.getDukeDialog(new Label(selfIntro), new ImageView(duke))
        );
        ...
        primaryStage.show();
        //Load the files
        String storageResponse = DukeStorage.loadTasks(Duke.gettList());
        dialogContainer.getChildren().addAll(
                DialogBox.getDukeDialog(new Label(storageResponse), new ImageView(duke))
        );
    }
