...
public class MainWindow extends AnchorPane {
    ...
    private Image userImage = new Image(this.getClass().getResourceAsStream("/images/challenge.jpg"));
    private Image dukeImage = new Image(this.getClass().getResourceAsStream("/images/teacher.jpg"));
    ...
    private void handleUserInput() {
        stage = (Stage) dialogContainer.getScene().getWindow();
