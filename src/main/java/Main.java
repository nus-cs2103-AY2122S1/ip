...
public class Main extends Application{
    private final Duke DUKE = new Duke("/Users/hungkhoaitay/Duke.Duke/data/duke.txt");
    ...
    private Image duke = new Image(this.getClass().getResourceAsStream("/images/man.png"));
