...
public class Date {
    ...
    private LocalTime formatTime(String timeString) throws NumberFormatException {
    ...
    private LocalDate formatDate(String dateString) throws NumberFormatException {
