    ...
    public static ArrayList<Task> loadFile(File saveFile) throws FileNotFoundException {
        ...
        while(s.hasNext()) {
            ...
            if (type.equals("T")) {
                ...
                LocalDateTime sendThis = LocalDateTime.of(Integer.parseInt(datesplit[0]), Integer.parseInt(datesplit[1]), Integer.parseInt(datesplit[2]), Integer.parseInt(timesplit[0]), Integer.parseInt(timesplit[1]));
                if (type.equals("D")) {
