...
This is a task manager built upon a 
project template for a greenfield Java project that is named after the Java mascot _Duke_. Given below are instructions on how to use it.
