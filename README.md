# ShyBot project template

This is a project template for a greenfield Java project. It's named after the Java mascot _ShyBot_. Given below are
...
3. After that, locate the `src/main/java/ShyBot.java` file, right-click it, and choose `Run ShyBot.main()` (if the code
